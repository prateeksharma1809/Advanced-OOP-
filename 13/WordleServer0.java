...
public class WordleServer0 {
	...
	public WordleServer0() throws IOException {
	...
	public static void main(String[] args) throws IOException {
		...
		WordleServer0 ws = new WordleServer0();
		ws.startServer();
	...
	private void startServer() throws IOException {
		while (soManyWordToPLayWith > 0) {
			...
			Thread t = new ClientHandler0(socket, dis, dos, currentWord);
...
class ClientHandler0 extends Thread {
	...
	// Constructor
	public ClientHandler0(Socket s, DataInputStream dis2, DataOutputStream dos2, String currentWord) {
		this.socket = s;
		this.dis = dis2;
		this.dos = dos2;
